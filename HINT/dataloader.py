...
def csv_three_feature_2_dataloader(csvfile, shuffle, batch_size, phase='Phase 1'):
...
def smiles_txt_to_2lst(smiles_txt_file):
    if 'train' in smiles_txt_file:
        X = pd.read_csv('/data3/huyaojun/DrugTrail/clinical-trial-outcome-prediction/Clinical-Trail/trial-approval-prediction/train_x.csv')
        y = pd.read_csv('/data3/huyaojun/DrugTrail/clinical-trial-outcome-prediction/Clinical-Trail/trial-approval-prediction/train_y.csv')['outcome']
    else:
        X = pd.read_csv('/data3/huyaojun/DrugTrail/clinical-trial-outcome-prediction/Clinical-Trail/trial-approval-prediction/test_x.csv')
        y = pd.read_csv('/data3/huyaojun/DrugTrail/clinical-trial-outcome-prediction/Clinical-Trail/trial-approval-prediction/test_y.csv')['outcome']
