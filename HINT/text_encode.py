...
output:
    data/text2embedding.pkl (preprocessing)
    text_embedding 
'''
...
def get_all_texts():
    input_file = '/data3/huyaojun/DrugTrail/clinical-trial-outcome-prediction/Clinical-Trail/All_data_prepared-GDP-smile-icd.csv'
...
def save_sentence_bert_dict_pkl_c(c):
    ...
    biobert = BiobertEmbedding(model_path = '/data2/huyaojun/Ecgedit/model/Bio_ClinaBert/')
    def text2vec(text):
